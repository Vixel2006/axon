...
from fajr.fajr_bindings.ctypes_definitions import CTensor, ClipExtras
from fajr.fajr_bindings.c_wrapper_functions import c_relu, c_log, c_exp, c_abs, c_neg, c_relu_grad_op, c_log_grad_op, c_abs_grad_op, c_exp_grad_op, c_neg_grad_op, c_clip, c_clip_grad_op
