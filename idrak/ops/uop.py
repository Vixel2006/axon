...
class UOp(LazyOp):
    @staticmethod
    def calc_out_shape(a: Tensor, **kwargs) -> tuple[int, ...]: return a.shape

    def create_ctx_struct(self, *args, **kwargs): return None
...
class Log(UOp):
    @staticmethod
    def forward(out: "Tensor", a: "Tensor"): c_log(a._c_tensor, out._c_tensor)
...
class Exp(UOp):
    @staticmethod
    def forward(out: "Tensor", a: "Tensor"): c_exp(a._c_tensor, out._c_tensor)
...
class Abs(UOp):
    @staticmethod
    def forward(out: "Tensor", a: "Tensor"): c_abs(a._c_tensor, out._c_tensor)
...
class Neg(UOp):
    @staticmethod
    def forward(out: "Tensor", a: "Tensor"):  c_neg(a._c_tensor, out._c_tensor)
...
class Clip(UOp):
    ...
    @staticmethod
    def forward(out: "Tensor", a: "Tensor", min_val: float, max_val: float): c_clip(a._c_tensor, min_val, max_val, out._c_tensor)
