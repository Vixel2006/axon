...
/**
 * @brief CUDA kernel for element-wise exponential of a tensor.
 *
 * This kernel uses a grid-stride loop to ensure all elements are processed,
 * regardless of tensor size or the number of threads launched. It applies the
 * single-precision exponential function, expf(), to each element.
 *
